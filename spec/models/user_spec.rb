...
RSpec.describe User, type: :model do
  describe '新規登録/ユーザー情報' do
    ...
    context '内容に問題がある場合' do
      ...
      it 'ユーザー本名のフリガナは、全角（カタカナ）での入力が必須であること' do
        @user.user_name_kana_family = 'かける'
        @user.valid?
